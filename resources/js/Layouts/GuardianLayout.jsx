...
export default function GuardianLayout({ children }) {
    ...
    const navigation = [
        { name: 'Dashboard', href: route('guardian.dashboard'), routeName: 'guardian.dashboard', icon: Home },
        { name: 'My Students', href: route('guardian.students.index'), routeName: 'guardian.students.index', icon: Users },
        { name: 'Schedules', href: route('guardian.schedules.index'), routeName: 'guardian.schedules.index', icon: Clock },
        { name: 'Announcements', href: route('guardian.announcements.index'), routeName: 'guardian.announcements.index', icon: MessageSquare },
    ];
            ...
            >
                ...
                <div className="flex-grow">
                    <div className={cn(
                        ...
                        {!isSidebarCollapsed && (
                            <div>
                                <h2 className="font-semibold text-gray-800">{auth?.user?.name || 'Guardian'}</h2>
