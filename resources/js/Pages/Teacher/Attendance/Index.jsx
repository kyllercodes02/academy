...
export default function Index({ 
    ...
    const loadAttendanceData = async (filterParams) => {
        setLoading(true);
        try {
            const response = await fetch(route('teacher.attendance.data', filterParams));
    ...
    const handleStatusUpdate = async (studentId, newStatus) => {
        setLoading(true);
        try {
            await router.post(route('teacher.attendance.update'), {
    ...
    const handleCheckOutSubmit = () => {
        ...
        router.post(route('teacher.attendance.record-check-out'), {
    ...
    const handleBulkUpdate = (status) => {
        ...
        router.post(route('teacher.attendance.bulk-update'), {
            date: selectedDate,
            status: status,
        }, {
            preserveState: true,
