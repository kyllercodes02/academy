...
export default function GuardianLogin({ status, canResetPassword }) {
            ...
            <div className="w-full max-w-md mx-auto">
                ...
                <div className="bg-white shadow-xl rounded-xl border border-gray-100 p-8">
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {canResetPassword && (
                                <a
                                    href={route('guardian.password.request')}
                ...
                <div className="mt-8 text-center">
                    <p className="text-sm text-gray-500">
                        Secured by Zion Academy Guardian System
                    </p>
                </div>
            </div>
        </GuestLayout>
