    ...
    <div class="header-section">
        ...
        <div class="header-info">
            <div class="header-left">
                ...
                <div><strong>School Year:</strong> <span class="underline">__________________</span></div>
            </div>
    ...
    <div class="main-table-container">
        <table class="sf2">
            <thead>
                ...
                <tr>
                    <th class="date-col rotate">M</th>
                    <th class="date-col rotate">T</th>
                    <th class="date-col rotate">W</th>
                    <th class="date-col rotate">TH</th>
                    <th class="date-col rotate">F</th>
                    <th class="date-col rotate">S</th>
                    <th class="date-col rotate">S</th>
                    <th class="date-col rotate">M</th>
                    <th class="date-col rotate">T</th>
                    <th class="date-col rotate">W</th>
            ...
            <tbody>
                @foreach ($students as $student)
                    <tr>
                        <td class="name-col">{{ $student->last_name ?? '' }}, {{ $student->first_name ?? $student->name ?? '' }}{{ $student->middle_name ? ', ' . $student->middle_name : '' }}</td>
                        @php
            ...
            <table class="summary-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="width: 30%;">MALE</td>
                        <td style="width: 30%;">FEMALE</td>
                    </tr>
                    <tr>
